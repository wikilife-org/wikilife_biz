...
class AccountService(object):
    ...
    def update_profile(self, user_id, tz_, source, country, region , city):
        self._profile_srv.update_profile(user_id, tz_, source, country, region , city)
    ...
    def create_autogenerated_account(self, user_name_prefix=""):
        ...
        try:
            ...
            self._profile_srv.add_profile(created_user_id, user_tz_name, DEFAULT_SOURCE, DEFAULT_BIRTHDATE, DEFAULT_HEIGHT, DEFAULT_WEIGHT, DEFAULT_GENDER, DEFAULT_COUNTRY, DEFAULT_REGION, DEFAULT_CITY)
