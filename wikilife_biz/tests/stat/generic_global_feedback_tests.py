...
from wikilife_stat_service.stat_readers.generic_global_feedback import GenericGlobalFeedbackReader
...
class Test(BaseTest):
    ...
    def setUp(self):
        self.mgr = self.get_manager_builder().build_generic_global_log_stats_manager()
        ...
        entry3 = json.loads("""
{
   ...
   "log_nodes":{
      "log1":{
        ...
        self.managers.generic_global_log_stats_mgr.save_log_day(entry1)
        self.managers.generic_global_log_stats_mgr.save_log_day(entry2)
        self.managers.generic_global_log_stats_mgr.save_log_day(entry3)
        print " done."
    ...
    def test_get_logs(self):
        ...
        result = GenericGlobalFeedbackReader(self.get_logger(), self.managers).read_stat(date, "log1", (7, 14))
